...
# Does treatment of COVID-19 with paxlovid reduce hospitalization or death?
...
```{r,out.width="65%"}
vtree(stemcell, "sex prior.radiation c1c2", sameline=TRUE, showvarnames=FALSE, summary="cmv   \nR %npct%", splitwidth=Inf)
```
